...
namespace FishPig\WordPress_Yoast\Controller\Search\View;

class SeoMetaDataProvider extends \FishPig\WordPress\Controller\Search\View\SeoMetaDataProvider
{
    /**
    ...
    ): void 
    {
        ...
        // Meta Title
        $this->setMetaTitle(
            $this->stringRewriter->rewrite($this->config->getTitleFormat('search_wpseo'), $search)
        );
    }
}
